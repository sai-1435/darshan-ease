...
const OrganizerEdit = ({ match }) => {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                const response = await axios.get(`https://darshan-ease-2.onrender.com/organizer/organizer/${id}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://darshan-ease-2.onrender.com/organizer/organizeredit/${id}`, user);
